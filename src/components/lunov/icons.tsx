export function SparkleIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M12 2l1.2 6.2L19 9l-5.8.8L12 16l-1.2-6.2L5 9l5.8-.8L12 2zm7 11l.8 3.5L23 17l-3.2.5L19 21l-1.8-3.5L14 17l3.2-.5L19 13zm-14 0l.8 3.5L9 17l-3.2.5L5 21l-1.8-3.5L0 17l3.2-.5L5 13z" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="m8 9-4 4 4 4m8-8 4 4-4 4M14 4l-4 16"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M4 7v10c0 1.657 3.582 3 8 3s8-1.343 8-3V7M4 12c0 1.657 3.582 3 8 3s8-1.343 8-3"
      />
    </svg>
  );
}

export function DevicePhoneIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M10.5 3h3A2.25 2.25 0 0 1 15.75 5.25v13.5A2.25 2.25 0 0 1 13.5 21h-3a2.25 2.25 0 0 1-2.25-2.25V5.25A2.25 2.25 0 0 1 10.5 3Z"
      />
      <path strokeLinecap="round" d="M12 17.25h.008v.008H12z" />
    </svg>
  );
}
