import type { HeroMockupLabels } from "@/i18n/types";
...
export function HeroLaptopMockup({ labels }: Props) {
  const readyState = labels.queueRows[1]?.state;
  ...
  return (
    ...
    >
      ...
      <div className="relative max-sm:mx-auto max-sm:w-[min(100%,380px)] sm:w-full md:[perspective:1400px] md:[perspective-origin:55%_38%]">
        <div className="relative md:-translate-y-1 md:rotate-x-[5deg] md:rotate-y-[-9deg] md:transform-gpu md:transition-[transform,filter] md:duration-[680ms] md:ease-[cubic-bezier(0.22,1,0.36,1)] md:hover:rotate-x-[3deg] md:hover:rotate-y-[-6deg] md:hover:drop-shadow-[0_28px_56px_rgba(212,255,63,0.07)]">
          <div className="rounded-[1.25rem] border border-zinc-600/75 bg-gradient-to-b from-zinc-600/95 via-zinc-900 to-zinc-950 p-2 shadow-[0_32px_70px_-22px_rgba(0,0,0,0.88),0_0_0_1px_rgba(255,255,255,0.07)_inset] ring-1 ring-black/45 transition-[box-shadow,border-color] duration-[640ms] ease-[cubic-bezier(0.22,1,0.36,1)] md:hover:shadow-[0_36px_80px_-22px_rgba(0,0,0,0.9),0_0_42px_-24px_rgba(212,255,63,0.06)] sm:rounded-[1.35rem] sm:p-[11px]">
                ...
                <div className="relative flex min-h-0 flex-1 flex-col gap-2 p-2.5 sm:gap-2.5 sm:p-3 md:gap-3 md:p-3.5 lg:p-4">
                  ...
                  <div className="flex shrink-0 flex-wrap items-center justify-between gap-2 border-b border-white/[0.045] pb-2">
                    ...
                    <div className="flex items-center gap-2 font-mono text-[7px] tabular-nums text-zinc-600 sm:text-[8px]">
                      ...
                      <span className="hidden sm:inline">{labels.bufferOk}</span>
                    </div>
                  </div>
                      ...
                      <div className="space-y-1.5 sm:space-y-2">
                        <div className="rounded-md bg-white/[0.045] px-2 py-1.5 ring-1 ring-lime/22 sm:py-2">
                          ...
                          <div className="font-display mt-0.5 flex items-baseline justify-between gap-2 font-mono tabular-nums sm:mt-1">
                            ...
                            <span className="text-[9px] text-zinc-500">LUFS</span>
                          </div>
                        </div>
                        <div className="rounded-md bg-black/28 px-2 py-1.5 ring-1 ring-white/[0.045] sm:py-2">
                          ...
                          <div className="font-display mt-0.5 flex items-baseline justify-between gap-2 font-mono sm:mt-1">
                            ...
                            <span className="text-[9px] text-zinc-600">dBTP</span>
                          </div>
                        </div>
                        <div className="rounded-md bg-black/28 px-2 py-1.5 ring-1 ring-white/[0.045] sm:py-2">
                          <div className="text-[8px] font-medium uppercase tracking-[0.14em] text-zinc-500">
                          ...
                          <div className="font-display mt-0.5 flex items-baseline justify-between gap-2 sm:mt-1">
                            ...
                            <span className="text-[9px] text-zinc-600">dB</span>
                          </div>
                        </div>
                      </div>
                        ...
                        {labels.queueRows.map((row) => (
                          ...
                          >
                            ...
                            <div className="min-w-0 text-right">
                              ...
                              <div
                                className={`text-[7px] font-medium uppercase tracking-wide ${row.state === readyState ? "text-lime/90" : "text-amber-400/90"}`}
                              >
                                {row.state}
                              </div>
                            </div>
                    ...
                    <div className="flex min-h-0 flex-col gap-2 sm:gap-2">
                        ...
                        <div className="rounded-lg border border-white/[0.065] bg-gradient-to-br from-zinc-900/72 to-black/88 px-2 py-2 ring-1 ring-white/[0.04] sm:px-2.5">
                          ...
                          <div className="mt-2 space-y-2">
                            ...
                            <div className="flex items-center justify-between font-mono text-[7px] text-zinc-500">
                              <span>{labels.bounceProgress}</span>
                              <span className="text-zinc-600">{labels.bounceMeta}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex shrink-0 items-center justify-between gap-2 rounded-md border border-white/[0.055] bg-black/50 px-2 py-1.5 ring-1 ring-white/[0.035]">
                        <div className="flex min-w-0 items-center gap-2">
                          <span className="relative flex size-4 shrink-0 items-center justify-center rounded-md bg-lime/10 ring-1 ring-lime/20">
                            <span className="lunov-soft-pulse absolute size-1.5 rounded-full bg-lime shadow-[0_0_8px_rgba(212,255,63,0.5)]" />
                          </span>
                          <span className="truncate text-[8px] font-medium text-zinc-400">
                            {labels.statusLine}
                          </span>
                        </div>
                        <span className="shrink-0 font-mono text-[7px] text-zinc-600">
                          {labels.build}
                        </span>
                      </div>
                    </div>
